 ...
 * MMP Reset
 */
@ApiModel(description = "MMP Reset")
...
public class OptionsMMPReset {
  ...
  **/
  ...
  @ApiModelProperty(value = "时间窗口（毫秒），1-5000之间，0表示停用MMP")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "冻结时长（毫秒），0表示一直冻结，需要调用重置API解冻")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "成交量上限（正数，至多2位小数）")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "净delta值上限（正数，至多2位小数）")
