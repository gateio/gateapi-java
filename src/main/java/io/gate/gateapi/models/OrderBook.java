...
public class OrderBook {
  ...
  **/
  ...
  @ApiModelProperty(value = "Order book ID, which is updated whenever the order book is changed. Valid only when `with_id` is set to `true`")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The timestamp of the response data being generated (in milliseconds)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The timestamp of when the orderbook last changed (in milliseconds)")
