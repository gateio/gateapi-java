...
public class SpotPricePutOrder {
  ...
  **/
  ...
  @ApiModelProperty(value = "Order type，default to `limit`  - limit : Limit Order - market : Market Order")
   ...
   * @return side
  **/
  @ApiModelProperty(required = true, value = "Order side  - buy: buy side - sell: sell side")
  ...
  **/
   ...
   * @return account
  **/
  @ApiModelProperty(required = true, value = "Trading account type.  Portfolio margin account must set to `cross_margin`  - normal: spot trading - margin: margin trading - cross_margin: cross_margin trading ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "time_in_force  - gtc: GoodTillCancelled - ioc: ImmediateOrCancelled, taker only ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The source of the order, including: - web: web - api: api - app: app")
