...
public class CrossMarginLoan {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Creation timestamp, in milliseconds")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Update timestamp, in milliseconds")
  ...
  **/
   ...
   * @return amount
  **/
  @ApiModelProperty(required = true, value = "Borrowed amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Deprecated. Currently, all statuses have been set to 2.  Borrow loan status, which includes:  - 1: failed to borrow - 2: borrowed but not repaid - 3: repayment complete")
