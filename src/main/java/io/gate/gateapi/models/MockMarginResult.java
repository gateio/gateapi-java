 ...
 * Margin result
 */
@ApiModel(description = "Margin result")
...
public class MockMarginResult {
  ...
  **/
  ...
  @ApiModelProperty(value = "Position combination type `original_position` - Original position `long_delta_original_position` - Positive delta + Original position `short_delta_original_position` - Negative delta + Original position")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The results of 33 pressure scenarios for MR1")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Stress testing")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Basis spread risk")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Volatility spread risk")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Option short risk")
