...
public class Ticker {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The latest seller's lowest price quantity; does not exist for batch query; exists for single query, and is empty if there is no data")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The latest buyer's highest price quantity; does not exist for batch query; exists for single query, and is empty if there is no data")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Change percentage in the last 24h")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "utc0 timezone, the percentage change in the last 24 hours")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "utc8 timezone, the percentage change in the last 24 hours")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Base currency trade volume in the last 24h")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Quote currency trade volume in the last 24h")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ETF net value")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ETF previous net value at re-balancing time")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ETF previous re-balancing time")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ETF current leverage")
