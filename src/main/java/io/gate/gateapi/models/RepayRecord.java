 ...
 * Repayment record
 */
@ApiModel(description = "Repayment record")
...
public class RepayRecord {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Borrowing time, timestamp")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Repayment time, timestamp")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Principal to be repaid before repayment")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Principal to be repaid after repayment")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Collateral quantity before repayment")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Collateral quantity after repayment")
