...
public class MyFuturesTrade {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Number of closed positions:  close_size=0 && size＞0       Open long position close_size=0 && size＜0       Open short position close_size>0 && size>0 && size <= close_size Close short postion close_size>0 && size>0 && size > close_size Close short position and open long position close_size<0 && size<0 && size >= close_size Close long postion close_size<0 && size<0 && size < close_size Close long position and open short position")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "User defined information")
