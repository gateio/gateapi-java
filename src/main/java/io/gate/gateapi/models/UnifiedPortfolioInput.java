 ...
 */
@ApiModel(description = "Input for the portfolio margin calculator.")
...
public class UnifiedPortfolioInput {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Spot orders")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Futures positions")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Futures order")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Options positions")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Option orders")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether to enable spot hedging.")
