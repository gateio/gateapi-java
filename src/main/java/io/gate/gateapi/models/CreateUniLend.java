 ...
 * Lend or redeem
 */
@ApiModel(description = "Lend or redeem")
...
public class CreateUniLend {
  ...
  **/
   ...
   * @return amount
  **/
  @ApiModelProperty(required = true, value = "The amount of currency could be lent")
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "type: lend - lend, redeem - redeem")
  ...
  **/
  ...
  @ApiModelProperty(value = "The minimum interest rate. If the value is too high, it might lead to the unsuccessful lending and no profit will be gained for that hour. ")
