...
public class MarginAccountBook {
  ...
  **/
  ...
  @ApiModelProperty(value = "Balance change record ID")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Balance changed timestamp")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The timestamp of the change (in milliseconds)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Currency changed")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Account currency pair")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Amount changed. Positive value means transferring in, while negative out")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Account book type.  Please refer to [account book type](#accountbook-type) for more detail")
