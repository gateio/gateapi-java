...
public class FuturesPriceTrigger {
  ...
  **/
  ...
  @ApiModelProperty(value = "How the order will be triggered   - `0`: by price, which means the order will be triggered if price condition is satisfied  - `1`: by price gap, which means the order will be triggered if gap of recent two prices of specified `price_type` are satisfied.  Only `0` is supported currently")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "How long (in seconds) to wait for the condition to be triggered before cancelling the order.")
