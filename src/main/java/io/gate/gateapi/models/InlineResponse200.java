...
public class InlineResponse200 {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Transfer status, PENDING - in process, SUCCESS - successful transfer, FAIL - failed transfer, PARTIAL_SUCCESS - Partially successful (this status will appear when transferring between sub-subs)")
