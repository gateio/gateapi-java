...
public class TradeFee {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "maker fee rate")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If GT deduction is enabled")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Taker fee rate if using GT deduction. It will be 0 if GT deduction is disabled")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Maker fee rate if using GT deduction. It will be 0 if GT deduction is disabled")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Loan fee rate of margin lending")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Point type. 0 - Initial version. 1 - new version since 202009")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Futures trading taker fee")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Future trading maker fee")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Delivery trading taker fee")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Delivery trading maker fee")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Deduction types for rates, 1 - GT deduction, 2 - Point card deduction, 3 - VIP rates")
