 ...
 */
@ApiModel(description = "Retrieve risk limit configurations for different tiers under a specified contract.")
...
public class FuturesLimitRiskTiers {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Initial margin rate")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Markets, visible only during market pagination requests")
