 ...
 * Collateral record
 */
@ApiModel(description = "Collateral record")
...
public class CollateralRecord {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The collateral amount before adjustment")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The collateral amount after adjustment")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The collateral ratio after adjustment")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Timestamp of the operation, in seconds")
