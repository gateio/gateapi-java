...
public class SubAccount {
  ...
  **/
   ...
   * @return loginName
  **/
  @ApiModelProperty(required = true, value = "Sub-account login name: Only letters, numbers and underscores are supported, and cannot contain other illegal characters")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The sub-account's password. (Default: the same as main account's password)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The sub-account's email address. (Default: the same as main account's email address)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "State: 1-normal, 2-locked\"")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "\"Sub-account type: 1 - sub-account, 3 - cross margin account")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The user id of the sub-account")
