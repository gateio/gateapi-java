...
public class FlashSwapPreviewRequest {
  ...
  **/
  ...
  @ApiModelProperty(value = "Amount to sell. It is required to choose one parameter between `sell_amount` and `buy_amount`")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Amount to buy. It is required to choose one parameter between `sell_amount` and `buy_amount`")
