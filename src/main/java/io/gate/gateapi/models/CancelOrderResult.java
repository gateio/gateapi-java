...
public class CancelOrderResult {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Custom order information")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Empty by default. If cancelled order is cross margin order, this field is set to `cross_margin`")
