...
public class Contract {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Risk limit base,deprecated")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Step of adjusting risk limit,deprecated")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Maximum risk limit the contract allowed,deprecated,It is recommended to use /futures/{settle}/risk_limit_tiers to query risk limits.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "`in_delisting=true` And when position_size>0, it means the contract is in the offline transition period `in_delisting=true` And when position_size=0, it means the contract is offline")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether bouns is enabled")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether portfolio margin account is enabled")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Created time of the contract")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The factor for the maximum of the funding rate. Maximum of funding rate = (1/market maximum leverage - maintenance margin rate) * funding_cap_ratio")
