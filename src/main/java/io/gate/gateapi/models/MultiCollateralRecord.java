 ...
 */
@ApiModel(description = "Multi-Collateral adjustment record.")
...
public class MultiCollateralRecord {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Collateral record ID")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The collateral ratio before adjustment")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Operation time, timestamp in seconds.")
