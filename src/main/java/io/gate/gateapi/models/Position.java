...
public class Position {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The initial margin occupied by the position, applicable to the portfolio margin account")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Maintenance margin required for the position, applicable to portfolio margin account")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Realized PNL - Position P/L")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Realized PNL -  Funding Fees")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Realized PNL - Transaction Fees")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Ranking of auto deleveraging, a total of 1-5 grades, `1` is the highest, `5` is the lowest, and `6` is the special case when there is no position held or in liquidation")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Position mode, including:  - `single`: dual mode is not enabled- `dual_long`: long position in dual mode- `dual_short`: short position in dual mode")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Update id. Each time the position is updated, the value will be +1.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "First Open Time")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(user, contract, size, leverage, riskLimit, leverageMax, maintenanceRate, value, margin, entryPrice, liqPrice, markPrice, initialMargin, maintenanceMargin, unrealisedPnl, realisedPnl, pnlPnl, pnlFund, pnlFee, historyPnl, lastClosePnl, realisedPoint, historyPoint, adlRanking, pendingOrders, closeOrder, mode, crossLeverageLimit, updateTime, updateId, openTime);
  }
