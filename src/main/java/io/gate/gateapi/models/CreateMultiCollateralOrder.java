...
public class CreateMultiCollateralOrder {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "current - current, fixed - fixed, if not specified, default to current")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Fixed interest rate loan period: 7d - 7 days, 30d - 30 days. Must be provided for fixed")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Fixed interest rate, must be specified for fixed")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Collateral currency and amount")
