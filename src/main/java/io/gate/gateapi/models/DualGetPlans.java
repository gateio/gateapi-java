...
public class DualGetPlans {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Instrument Name")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Minimum Copies")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Maximum Copies")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Per Unit Value")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Status:   `NOTSTARTED`-not started  `ONGOING`-ongoing  `ENDED`-ended")
