...
public class PositionClose {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "PNL - Position P/L")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "PNL - Funding Fees")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "PNL - Transaction Fees")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Max Trade Size")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Cumulative closed position volume")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "When 'side' is 'long,' it indicates the opening average price; when 'side' is 'short,' it indicates the closing average price.")
