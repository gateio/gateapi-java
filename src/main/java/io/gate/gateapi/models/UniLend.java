 ...
 * Loan record
 */
@ApiModel(description = "Loan record")
...
public class UniLend {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Lent amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Amount not reinvested")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Created time of the lending order")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Upated time of the lending order")
