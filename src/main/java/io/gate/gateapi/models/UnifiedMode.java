...
public class UnifiedMode {
   ...
   * @return mode
  **/
  @ApiModelProperty(required = true, value = "Portfolio mode - cross_margin : cross margin - usdt_futures : usdt futures")
   ...
   * @return enabled
  **/
  @ApiModelProperty(required = true, value = "Is it enabled?")
