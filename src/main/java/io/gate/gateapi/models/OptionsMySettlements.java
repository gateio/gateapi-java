...
public class OptionsMySettlements {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Settlement profit (quote currency)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Fee (quote currency)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The accumulated profit and loss of opening a position, including premium, fee, settlement profit, etc. (quote currency)")
