...
public class MultiChainAddressItem {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Notes that some currencies required(e.g., Tag, Memo) when depositing")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Note type, `Tag` or `Memo`")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The obtain failed status- 0: address successfully obtained- 1: failed to obtain address")
