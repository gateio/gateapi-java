 ...
 */
@ApiModel(description = "Currencies supported in flash swap")
...
public class FlashSwapCurrency {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Minimum amount required in flash swap")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Maximum amount allowed in flash swap")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Currencies which can be swapped to from this currency")
