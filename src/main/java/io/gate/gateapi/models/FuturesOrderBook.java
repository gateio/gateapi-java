...
public class FuturesOrderBook {
  ...
  **/
  ...
  @ApiModelProperty(value = "Order Book ID. Increases by 1 on every order book change. Set `with_id=true` to include this field in response")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Response data generation timestamp")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Order book changed timestamp")
