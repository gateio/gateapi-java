...
public class RepayLoan {
  ...
  **/
   ...
   * @return repayAmount
  **/
  @ApiModelProperty(required = true, value = "Repayment amount, it is mandatory when making partial repayments")
   ...
   * @return repaidAll
  **/
  @ApiModelProperty(required = true, value = "Repayment method, set to `true` for full repayment, and `false` for partial repayment; When set to false for partial repayment, the repay_amount parameter cannot be greater than the remaining amount to be repaid by the user. ")
