...
public class OrderPatch {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "New order amount. `amount` and `price` must specify one of them")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "New order price. `amount` and `Price` must specify one of them\"")
