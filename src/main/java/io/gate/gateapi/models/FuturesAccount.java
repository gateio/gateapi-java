...
public class FuturesAccount {
  ...
  **/
  ...
  @ApiModelProperty(value = "total is the balance after the user's accumulated deposit, withdraw, profit and loss (including realized profit and loss, fund, fee and referral rebate), excluding unrealized profit and loss.  total = SUM(history_dnw, history_pnl, history_fee, history_refr, history_fund)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The available balance for transferring or trading(including bonus.  Bonus can't be be withdrawn. The transfer amount needs to deduct the bonus)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether dual mode is enabled")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether portfolio margin account mode is enabled")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Initial margin position, applicable to the portfolio margin account model")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The maintenance deposit occupied by the position is suitable for the new classic account margin model and unified account model")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Perpetual Contract Bonus")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Classic account margin mode, true-new mode, false-old mode")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Full -warehouse hanging order deposit, suitable for the new classic account margin model")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The initial security deposit of the full warehouse is suitable for the new classic account margin model")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Maintain deposit in full warehouse, suitable for new classic account margin models")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The full warehouse does not achieve profit and loss, suitable for the new classic account margin model")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Full warehouse available amount, suitable for the new classic account margin model")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Ware -position margin, suitable for the new classic account margin model")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether to open a new two-way position mode")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Margin mode, 0-classic margin mode, 1-cross-currency margin mode, 2-combined margin mode")
