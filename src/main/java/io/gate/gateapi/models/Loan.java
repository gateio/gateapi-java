...
public class Loan {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Loan rate. Only rates in [0.0001, 0.01] are supported.  Not required in lending. Market rate calculated from recent rates will be used if not set")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Loan days. Only 10 is supported for now")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether to auto renew the loan upon expiration")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Currency pair. Required if borrowing")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Amount not lent out yet")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Outstanding interest yet to be paid")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Original loan ID of the loan if auto-renewed, otherwise equals to id")
