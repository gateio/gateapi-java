 ...
 */
@ApiModel(description = "User's currency statistics data")
...
public class UserLtvInfo {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Minimum borrowable amount for the loan currency")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Remaining borrowable amount for the loan currency")
