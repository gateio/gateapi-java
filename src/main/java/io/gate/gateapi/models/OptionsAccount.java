...
public class OptionsAccount {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "仓位价值，做多仓位价值为正，做空仓位价值为负")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "账户权益，账户余额与仓位价值的和")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If the account is allowed to short")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "是否启用MMP")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "是否触发仓位强平")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "｜ 保证金模式： - 0：经典现货保证金模式 - 1：跨币种保证金模式 - 2：组合保证金模式")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Initial position margin")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Position maintenance margin")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "未完成卖单的保证金")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "未完成买单的保证金")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "未完成订单数量上限")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "名义价值上限，包含仓位以及未完成订单的名义价值")
