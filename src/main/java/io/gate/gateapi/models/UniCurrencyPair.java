 ...
 */
@ApiModel(description = "Currency pair of the loan")
...
public class UniCurrencyPair {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Minimum borrow amount of base currency")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Minimum borrow amount of quote currency")
