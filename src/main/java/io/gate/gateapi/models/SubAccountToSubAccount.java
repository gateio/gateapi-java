...
public class SubAccountToSubAccount {
  ...
  **/
  ...
  @ApiModelProperty(value = "Transfer from the account. (deprecate, use `sub_account_from_type` and `sub_account_to_type` instead)")
  ...
  **/
  @ApiModelProperty(required = true, value = "Transfer from the user id of the sub-account")
  ...
  **/
  @ApiModelProperty(required = true, value = "The sub-account's outgoing trading account, spot - spot account, futures - perpetual contract account, delivery - delivery contract account.")
   ...
   * @return subAccountTo
  **/
  @ApiModelProperty(required = true, value = "Transfer to the user id of the sub-account")
  ...
  **/
  @ApiModelProperty(required = true, value = "The sub-account's incoming trading account, spot - spot account, futures - perpetual contract account, delivery - delivery contract account")
