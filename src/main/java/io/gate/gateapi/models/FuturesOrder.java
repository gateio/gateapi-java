...
public class FuturesOrder {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, createTime, finishTime, finishAs, status, contract, size, iceberg, price, close, isClose, reduceOnly, isReduceOnly, isLiq, tif, left, fillPrice, text);
  }
