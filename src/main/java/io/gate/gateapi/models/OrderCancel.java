...
public class OrderCancel {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The custom data that the user remarked when amending the order")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether the batch of orders succeeded")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Error label, if any, otherwise an empty string")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Detailed error message, if any, otherwise an empty string")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Last modification time of order")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Creation time of order (in milliseconds)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Last modification time of order (in milliseconds)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Order Type    - limit : Limit Order - market : Market Order")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Account types， spot - spot account, margin - margin account, unified - unified account, cross_margin - cross margin account.  Portfolio margin accounts can only be set to `cross_margin`")
  ...
  **/
   ...
   * @return amount
  **/
  @ApiModelProperty(required = true, value = "When `type` is limit, it refers to base currency.  For instance, `BTC_USDT` means `BTC`  When `type` is `market`, it refers to different currency according to `side`  - `side` : `buy` means quote currency, `BTC_USDT` means `USDT` - `side` : `sell` means base currency，`BTC_USDT` means `BTC` ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Price can't be empty when `type`= `limit`")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Time in force  - gtc: GoodTillCancelled - ioc: ImmediateOrCancelled, taker only - poc: PendingOrCancelled, makes a post-only order that always enjoys a maker fee - fok: FillOrKill, fill either completely or none Only `ioc` and `fok` are supported when `type`=`market`")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Amount to display for the iceberg order. Null or 0 for normal orders.  Hiding all amount is not supported.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Used in margin or cross margin trading to allow automatic loan of insufficient amount if balance is not enough.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Enable or disable automatic repayment for automatic borrow loan generated by cross margin order. Default is disabled. Note that:  1. This field is only effective for cross margin orders. Margin account does not support setting auto repayment for orders. 2. `auto_borrow` and `auto_repay` can be both set to true in one order.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Amount traded to fill ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Points used to deduct fee")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "GT used to deduct maker fee")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "GT used to deduct taker fee")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Orders between users in the same `stp_id` group are not allowed to be self-traded  1. If the `stp_id` of two orders being matched is non-zero and equal, they will not be executed. Instead, the corresponding strategy will be executed based on the `stp_act` of the taker. 2. `stp_id` returns `0` by default for orders that have not been set for `STP group`")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Self-Trading Prevention Action. Users can use this field to set self-trade prevetion strategies  1. After users join the `STP Group`, he can pass `stp_act` to limit the user's self-trade prevetion strategy. If `stp_act` is not passed, the default is `cn` strategy。 2. When the user does not join the `STP group`, an error will be returned when passing the `stp_act` parameter。 3. If the user did not use 'stp_act' when placing the order, 'stp_act' will return '-'  - cn: Cancel newest, Cancel new orders and keep old ones - co: Cancel oldest, Cancel old orders and keep new ones - cb: Cancel both, Both old and new orders will be cancelled")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "How the order was finished.  - open: processing - filled: filled totally - cancelled: manually cancelled - ioc: time in force is `IOC`, finish immediately - stp: cancelled because self trade prevention ")
