 ...
 * Flash swap order
 */
@ApiModel(description = "Flash swap order")
...
public class FlashSwapOrder {
  ...
  **/
  ...
  @ApiModelProperty(value = "Flash swap order ID")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Currency to sell")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Currency to buy")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Flash swap order status  `1` - success `2` - failure")
