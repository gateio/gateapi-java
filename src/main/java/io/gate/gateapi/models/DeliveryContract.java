...
public class DeliveryContract {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Cycle type, e.g. WEEKLY, QUARTERLY")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Fair basis rate")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Fair basis value")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Funding used for calculating impact bid, ask price")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Settle price")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Settle price update interval")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Settle price update duration in seconds")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Contract expiry timestamp")
