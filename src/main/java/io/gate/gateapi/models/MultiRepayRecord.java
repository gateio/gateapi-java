 ...
 * Mult Repay Record
 */
@ApiModel(description = "Mult Repay Record")
...
public class MultiRepayRecord {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Repayment record ID")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Ltv before the operation")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Ltv after the operation")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Repayment time, timestamp in seconds.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of borrowing information")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of collateral information")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total Interest List")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of left repay interest")
