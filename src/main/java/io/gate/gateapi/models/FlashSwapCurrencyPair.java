 ...
 */
@ApiModel(description = "List all supported currencies in flash swap")
...
public class FlashSwapCurrencyPair {
  ...
  **/
  ...
  @ApiModelProperty(value = "The currency pair, BTC_USDT represents selling Bitcoin (BTC) and buying Tether (USDT).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "BTC", value = "The currency to be sold")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "USDT", value = "The currency to be bought")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0.00001", value = "The minimum quantity required for selling")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100", value = "The maximum quantity allowed for selling")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "10", value = "The minimum quantity required for buying")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "10000000", value = "The maximum quantity allowed for buying")
