...
public class CrossMarginBalance {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Negative Liabilities. Formula:Min[available+total+unrealized_pnl,0]")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Borrowing to Open Positions in Futures")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Equity. Formula: available + freeze - borrowed + futures account's total + unrealized_pnl")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total freeze. Formula: freeze + position_initial_margin + order_margin")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total liabilities. Formula: Max[Abs[Min[quity - total_freeze,0], borrowed]] - futures_pos_liab")
