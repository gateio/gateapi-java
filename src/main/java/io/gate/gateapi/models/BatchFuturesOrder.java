...
public class BatchFuturesOrder {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Error label, only exists if execution fails")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Error detail, only present if execution failed and details need to be given")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Set side to close dual-mode position. `close_long` closes the long side; while `close_short` the short one. Note `size` also needs to be set to 0")
