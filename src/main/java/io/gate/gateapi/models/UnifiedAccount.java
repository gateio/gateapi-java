...
public class UnifiedAccount {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Time of the most recent refresh")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total account assets converted to USD, i.e. the sum of `(available + freeze) * price`  in all currencies (deprecated, to be deprecated, replaced by unified_account_total)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The total borrowed amount in USD, calculated as the sum of the product of `borrowed * price` for all currencies (excluding points cards).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total amount of the portfolio margin account")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total liabilities of the portfolio margin account")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total equity of the portfolio margin account")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total order loss, in USDT")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Spot hedging status, true - enabled, false - not enabled.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether to use funds as margin")
