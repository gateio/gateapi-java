 ...
 */
@ApiModel(description = "Options underlying detail")
...
public class OptionsUnderlyingTicker {
  ...
  **/
  ...
  @ApiModelProperty(value = "Total put options trades amount in last 24h")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total call options trades amount in last 24h")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Index price (quote currency)")
