 ...
 */
@ApiModel(description = "Accounts available to transfer:  - `spot`: spot account - `margin`: margin account - `futures`: perpetual futures account - `delivery`: delivery futures account - `options`: options account")
...
public class Transfer {
  ...
  **/
   ...
   * @return from
  **/
  @ApiModelProperty(required = true, value = "Account to transfer from")
   ...
   * @return to
  **/
  @ApiModelProperty(required = true, value = "Account to transfer to")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Futures settle currency. Required if transferring from or to futures account")
