 ...
 * Currency detail
 */
@ApiModel(description = "Currency detail")
...
public class UniCurrency {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The minimum lending amount, in the unit of the currency.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The total maximum lending amount, in USDT")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Maximum rate (Hourly)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Minimum rate (Hourly)")
