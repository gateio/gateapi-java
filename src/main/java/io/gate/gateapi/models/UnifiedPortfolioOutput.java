 ...
 */
@ApiModel(description = "The output of the portfolio margin calculator.")
...
public class UnifiedPortfolioOutput {
  ...
  **/
  ...
  @ApiModelProperty(value = "Total maintenance margin, including only the portfolio margin calculation results for positions in the risk unit,  excluding borrowed margin. If borrowing exists, conventional borrowing margin requirements will still apply.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total initial margin, calculated as the maximum of the following three combinations: position,  position + positive delta orders, position + negative delta orders.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Calculate time")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Risk unit")
