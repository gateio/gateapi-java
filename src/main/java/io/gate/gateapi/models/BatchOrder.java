...
public class BatchOrder {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Account type. spot - use spot account; margin - use margin account; cross_margin - use cross margin account, unified - unified account")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Time in force  - gtc: GoodTillCancelled - ioc: ImmediateOrCancelled, taker only - poc: PendingOrCancelled, makes a post-only order that always enjoys a maker fee - fok: FillOrKill, fill either completely or none")
