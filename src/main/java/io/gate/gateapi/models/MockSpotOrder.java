 ...
 * Spot orders
 */
@ApiModel(description = "Spot orders")
...
public class MockSpotOrder {
  ...
  **/
  ...
  @ApiModelProperty(value = "Initial order quantity for spot trading pairs, not involved in actual calculation.  Currently only supports three currencies: BTC, ETH.")
   ...
   * @return left
  **/
  @ApiModelProperty(required = true, value = "Unfilled quantity, involved in actual calculation.")
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "Order type, sell - sell order, buy - buy order.")
