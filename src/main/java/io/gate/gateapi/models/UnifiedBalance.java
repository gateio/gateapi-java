...
public class UnifiedBalance {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Negative Liabilities")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Contract opening position borrowing currency (abandoned, to be offline field)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total occupancy (discarded, to be offline field)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Quantity of funding")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Funding version")
