...
public class UnifiedSettings {
  ...
  **/
  ...
  @ApiModelProperty(value = "USDT contract switch. If not transmitted, the current switch value is used. If not transmitted for the first time, the default value is off.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Spot hedging switch. If not transmitted, the current switch value is used. If not transmitted for the first time, the default value is off.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "When the mode is set to combined margin mode, will funds be used as margin")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Option switch. If not transmitted, the current switch value is used. If not transmitted for the first time, the default value is off.")
