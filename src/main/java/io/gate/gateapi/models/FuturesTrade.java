...
public class FuturesTrade {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Trading time, with milliseconds set to 3 decimal places.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether internal trade. Internal trade refers to the takeover of liquidation orders by the insurance fund and ADL users. Since it is not a normal matching on the market depth, the transaction price may deviate, and it will not be recorded in the K-line. If it is not an internal trade, this field will not be returned.")
