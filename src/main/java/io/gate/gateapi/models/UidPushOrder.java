...
public class UidPushOrder {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Recipient User ID")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Withdrawal Status  - CREATING: Creating - PENDING: Waiting for receiving(Please contact the other party to accept the transfer on the Gate official website) - CANCELLING: Cancelling - CANCELLED: Revoked - REFUSING: Rejection - REFUSED: Rejected - RECEIVING: Receiving - RECEIVED: Success")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "PENDING Reason Tips")
