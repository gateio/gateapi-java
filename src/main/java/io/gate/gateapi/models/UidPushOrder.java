...
public class UidPushOrder {
    ...
    **/
    ...
    public UidPushOrder status(String status) {
     ...
     /**
     * Withdrawal Status  - CREATING: Creating - PENDING: Waiting for receiving - CANCELLING: Cancelling - CANCELLED: Revoked - REFUSING: Rejection - REFUSED: Rejected - RECEIVING: Receiving - RECEIVED: Success
     * @return status
    **/
    @javax.annotation.Nullable
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, pushUid, receiveUid, currency, amount, createTime, status);
    }
