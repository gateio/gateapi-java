 ...
 */
@ApiModel(description = "Order information that needs to be modified")
...
public class BatchAmendItem {
   ...
   * @return orderId
  **/
  @ApiModelProperty(required = true, value = "The order ID returned upon successful creation or the custom ID specified by the user during creation (i.e., the 'text' field).")
  ...
  **/
  ...
  @ApiModelProperty(value = "Default to spot, portfolio, and margin accounts if not specified. Use 'cross_margin' to query cross margin accounts. Only 'cross_margin' can be specified for portfolio margin accounts.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "trade amount, only one of amount and price can be specified")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "trade price, only one of amount and price can be specified")
