 ...
 */
@ApiModel(description = "Initiate a flash swap order preview")
...
public class FlashSwapOrderPreview {
  ...
  **/
  ...
  @ApiModelProperty(value = "Preview result ID")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Currency to sell which can be retrieved from supported currency list API `GET /flash_swap/currencies`")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Amount to sell")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Currency to buy which can be retrieved from supported currency list API `GET /flash_swap/currencies`")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Amount to buy")
