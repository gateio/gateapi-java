...
public class MarginUniApi {
    ...
    /**
     * Get lending market details (asynchronously)
     * 
     * @param currencyPair Currency pair (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @param currencies Array of currency names to query, maximum 10 (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    /**
     * Estimate interest rate for isolated margin currencies (asynchronously)
     * Interest rates change hourly based on lending depth, so completely accurate rates cannot be provided.
     * @param currencies Array of currency names to query, maximum 10 (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Query maximum borrowable amount by currency (asynchronously)
     * 
     * @param currency Query by specified currency name (required)
     * @param currencyPair Currency pair (required)
     * @param _callback The callback to be executed when the API call finishes
