...
public class UnifiedApi {
    ...
    /**
     * Batch query unified account can be borrowed up to a maximum. (asynchronously)
     * 
     * @param currencies Specify the currency names for querying in an array, separated by commas, with a maximum of 10 currencies. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public class APIlistUnifiedLoanRecordsRequest {
        ...
        /**
         * Set type
         * @param type The types of lending records, borrow - indicates the action of borrowing funds, repaying the borrowed funds (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> UpdateSuccess. </td><td>  -  </td></tr>
     </table>
     */
