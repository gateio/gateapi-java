...
public class CollateralLoanApi {
    ...
    /**
     * Place collateral loan order (asynchronously)
     * 
     * @param createCollateralOrder  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Collateral loan repayment (asynchronously)
     * 
     * @param repayLoan  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @param collateralCurrency Collateral currency (required)
    ...
    /**
     * Query user&#39;s collateralization ratio and remaining borrowable currencies (asynchronously)
     * 
     * @param collateralCurrency Collateral currency (required)
     * @param borrowCurrency Borrowed currency (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    public class APIlistCollateralCurrenciesRequest {
        ...
        /**
         * Set loanCurrency
         * @param loanCurrency Parameter loan_currency. If omitted, returns all supported borrowing currencies; if provided, returns the array of collateral currencies supported for that borrowing currency (optional)
