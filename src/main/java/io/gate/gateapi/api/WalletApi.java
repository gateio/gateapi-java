...
public class WalletApi {
    ...
    public class APIlistWithdrawalsRequest {
        ...
        /**
         * Set withdrawId
         * @param withdrawId The withdrawal record id starts with w, such as: w1879219868. When withdraw_id is not empty, the value querys this withdrawal record and no longer querys according to time (optional)
         * @return APIlistWithdrawalsRequest
         */
        ...
        /**
         * Set assetClass
         * @param assetClass The currency type of withdrawal record is empty by default. It supports users to query the withdrawal records in the main and innovation areas on demand. Value range: SPOT, PILOT  SPOT: Main Zone  PILOT: Innovation Zone (optional)
         * @return APIlistWithdrawalsRequest
         */
        ...
        /**
         * Set withdrawOrderId
         * @param withdrawOrderId User-defined order number when withdrawing. Default is empty. When not empty, the specified user-defined order number record will be queried (optional)
         * @return APIlistWithdrawalsRequest
         */
