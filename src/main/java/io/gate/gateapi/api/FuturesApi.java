...
public class FuturesApi {
     ...
     */
    public FuturesOrder cancelOrder(String orderId) throws ApiException {
        ApiResponse<FuturesOrder> resp = cancelOrderWithHttpInfo(orderId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<FuturesOrder> cancelOrderWithHttpInfo(String orderId) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call cancelOrderAsync(String orderId, final ApiCallback<FuturesOrder> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<FuturesOrder> cancelOrders(String contract, String side) throws ApiException {
        ApiResponse<List<FuturesOrder>> resp = cancelOrdersWithHttpInfo(contract, side);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<FuturesOrder>> cancelOrdersWithHttpInfo(String contract, String side) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call cancelOrdersAsync(String contract, String side, final ApiCallback<List<FuturesOrder>> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call createOrderValidateBeforeCall(FuturesOrder futuresOrder, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (futuresOrder == null) {
            throw new ApiException("Missing the required parameter 'futuresOrder' when calling createOrder(Async)");
        }
     ...
     * @param type Changing Type  - dnw: Deposit &amp; Withdraw - pnl: Profit &amp; Loss by reducing position - fee: Trading fee - refr: Referrer rebate - fund: Funding (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
