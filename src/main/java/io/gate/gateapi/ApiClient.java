...
import io.gate.gateapi.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/4.10.0/java");
    ...
    private Map<String, String> buildSignHeaders(String method, String fullUrl, RequestBody body) {
        ...
        try {
            rawQueryString = (splitUrl.length > 1) ? URLDecoder.decode(splitUrl[1], "UTF-8") : "";
        } catch (UnsupportedEncodingException e) {
            // do nothing
        }
        String signatureString = String.format("%s\n%s\n%s\n%s\n%s", method, splitUrl[0], rawQueryString,
